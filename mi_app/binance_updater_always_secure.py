#!/usr/bin/env python3
"""
Script para sincronizar datos de Binance P2P con Supabase (Versión Segura)
...
def obtener_credenciales():
    ...
    binance_api_key = os.getenv('BINANCE_API_KEY', 'Ds4W6XojH4dvM8eCre4U5rVBZpn03e8wM3POSOHHuDajdL33Cjg99JbLQ62n4Uti')
    binance_api_secret = os.getenv('BINANCE_API_SECRET', 'ljnha3p0yTg5tKpWm41sZMAH79LOsuwSiL7he6lU9ovUEM0D4e1AaeYkT1TFWo2A')
    ...
    if binance_api_key == 'Ds4W6XojH4dvM8eCre4U5rVBZpn03e8wM3POSOHHuDajdL33Cjg99JbLQ62n4Uti':
        logging.warning("⚠️ Usando credenciales de PRUEBAS de Binance. Configura BINANCE_API_KEY y BINANCE_API_SECRET en .env")
    
    if supabase_url == 'https://tmimwpzxmtezopieqzcl.supabase.co':
        logging.warning("⚠️ Usando credenciales de PRUEBAS de Supabase. Configura SUPABASE_URL y SUPABASE_KEY en .env")
...
def main():
    ...
    logging.info("🚀 Iniciando script de sincronización de datos de Binance (Versión Segura)")
